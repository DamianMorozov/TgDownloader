...
public sealed class TgSqlSourceHelper : TgSqlHelperBase<TgSqlTableSourceModel>
{
	#region Design pattern "Lazy Singleton"

#pragma warning disable CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
	private static TgSqlSourceHelper _instance;
#pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
	public static TgSqlSourceHelper Instance => LazyInitializer.EnsureInitialized(ref _instance);
	...
	public override bool IsValidXpLite(TgSqlTableSourceModel item) => new TgSqlTableSourceValidator().Validate(item).IsValid;
