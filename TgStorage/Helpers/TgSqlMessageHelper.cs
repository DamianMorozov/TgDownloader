...
public sealed class TgSqlMessageHelper : TgSqlHelperBase<TgSqlTableMessageModel>
{
	#region Design pattern "Lazy Singleton"

#pragma warning disable CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
	private static TgSqlMessageHelper _instance;
#pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
	public static TgSqlMessageHelper Instance => LazyInitializer.EnsureInitialized(ref _instance);
	...
	{ Id =0,  SourceId = 0, DtCreated = DateTime.Now, Type = TgMessageType.Message, Size = 0,  Message = string.Empty };
	...
	public override bool IsValidXpLite(TgSqlTableMessageModel item) => new TgSqlTableMessageValidator().Validate(item).IsValid;
