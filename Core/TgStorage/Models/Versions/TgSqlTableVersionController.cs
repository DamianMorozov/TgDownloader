...
#pragma warning disable CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
    private static TgSqlTableVersionController _instance;
#pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
    public static TgSqlTableVersionController Instance => LazyInitializer.EnsureInitialized(ref _instance);
    ...
    public override ValidationResult GetValidXpLite(TgSqlTableVersionModel item) => 
	    new TgSqlTableVersionValidator().Validate(item);
