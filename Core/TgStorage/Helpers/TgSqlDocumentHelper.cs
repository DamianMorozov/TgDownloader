...
public sealed class TgSqlDocumentHelper : TgSqlHelperBase<TgSqlTableDocumentModel>
{
	#region Design pattern "Lazy Singleton"

#pragma warning disable CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
	private static TgSqlDocumentHelper _instance;
#pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
	public static TgSqlDocumentHelper Instance => LazyInitializer.EnsureInitialized(ref _instance);
	...
	public override bool IsValidXpLite(TgSqlTableDocumentModel item) => new TgSqlTableDocumentValidator().Validate(item).IsValid;
