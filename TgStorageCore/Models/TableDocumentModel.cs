...
[Table("DOCUMENTS")]
public class TableDocumentModel : TableBase
{
    ...
    public TableDocumentModel(long id, long sourceId, long messageId, string fileName, long fileSize, long accessHash)
    {
        Id = id;
        SourceId = sourceId;
        MessageId = messageId;
    ...
    protected TableDocumentModel(SerializationInfo info, StreamingContext context) : base(info, context)
    {
